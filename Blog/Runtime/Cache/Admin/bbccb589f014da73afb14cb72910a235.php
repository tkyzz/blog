...
<div class="container"> 
  ...
  <div class="page-header">
    <h3><?php echo (L("_add_")); echo (L("Classify")); ?></h3>
  </div>
  <div class="MiniBox2">
    <form method="post" action="<?php echo U('addCategory');?>">
      <input type="text" class="form-control miniinput" placeholder="<?php echo (L("Classify")); echo (L("_name_")); ?>" name="cname"/>
      <input type="text" class="form-control miniinput" placeholder="分类标识" name="urlname"/>

      <input type="text" class="form-control miniinput" placeholder="<?php echo (L("Classify")); echo (L("_description_")); ?>" name="cdescription"/>
      <input type="hidden" name="pid" value="<?php echo ($pid); ?>">
      <button type="submit" class="btn btn-info "><?php echo (L("_add_")); echo (L("Classify")); ?></button>
    </form>
  </div>
