...
<html>
  <head>
    ...
    <link rel="icon" href="/Blog/Admin/View/Public/Img/favicon.ico" mce_href="/Blog/Admin/View/Public/Img/favicon.ico" type="image/x-icon" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="/Blog/Admin/View/Public/css/bootstrap.min.css">
    <link rel="stylesheet" href="/Blog/Admin/View/Public/css/login.css">
  ...
  <body>
    ...
    <div class="container">
      <form class="form-signin" role="form" method="post" action="<?php echo U('Admin/Login/Login_in');?>">
        ...
        <button class="btn btn-info" type="button" onclick="window.location.href=''"><?php echo (L("_Return_")); ?></button>
      </form>
    </div>
