...
<div class="container">
  <div class="page-header">
    <h3><?php echo (L("Classify")); ?></h3>
  </div>
  <div class="input-append"> <a href="<?php echo U('Category_add');?>" class="btn btn-info sousuo"><?php echo (L("_add_")); echo (L("Classify")); ?></a> </div>
  <div class="MiniBox2">
    <table width="100%" border="0" class="table table-hover" id="list" >
      <tr>
        <td width="5%"><b>ID</b></td>
        <td width="15%" style="text-align: left;
          padding-left:80px;"><b><?php echo (L("Classify")); ?></b></td>
        <td width="10%" style="text-align: left;
          padding-left:80px;"><b><?php echo (L("_biaozhi_")); ?></b></td>
        <td width="10%" ><b><?php echo (L("_jibie_")); ?></b></td>
        <td width="35%" class="biaoti"><b><?php echo (L("_description_")); ?></b></td>
        <td width="15%"><b><?php echo (L("_operation_")); ?></b></td>
      </tr>
      <?php if(is_array($cate)): foreach($cate as $key=>$v): ?><tr>
          <td><?php echo ($v["cid"]); ?></td>
          <td style="text-align: left;
          padding-left:80px;"><?php echo ($v["html"]); echo ($v["cname"]); ?></td>
          <td style="text-align: left;
          padding-left:80px;"><?php echo ($v["urlname"]); ?></td>
          <td><?php echo ($v["level"]); ?></td>
          <td class="biaoti"><?php echo ($v["cdescription"]); ?></td>
          <td>
            <span onclick="location.href='<?php echo U('Category_add',array('pid'=>$v['cid']));?>'">增加子类</span>
          <span onclick="location.href='/index.php/Admin/Category/mod/id/<?php echo ($v["cid"]); ?>'"><?php echo (L("_editor_")); ?></span> <span onclick="if(confirm('<?php echo (L("_suredel_")); ?>'))window.location.href='/index.php/Admin/Category/del/id/<?php echo ($v["cid"]); ?>'">删除</span></td>
        </tr><?php endforeach; endif; ?>
      <tr>
        <td colspan="6" class="biaoti" style="padding-top:25px;"></td>
      </tr>
    </table>
  </div>
    <div class="footer">
