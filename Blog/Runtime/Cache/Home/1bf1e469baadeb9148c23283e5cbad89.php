...
<header id="header" class="clearfix">
  <div class="container">
    <div class="col-group">
      <div class="site-name"> <a id="logo" href=""> <?php echo (C("blogname")); ?> </a>
        <h1><?php echo (C("blogname")); ?></h1>
      </div>
      <div>
        <nav id="nav-menu" class="clearfix">
          <?php if(is_array($menu)): foreach($menu as $key=>$m): ?><a class="
          <?php if(($m["mname"] == 首页)): ?>current<?php endif; ?>" href="<?php echo ($m["url"]); ?>"  title="<?php echo ($m["mname"]); ?>"><?php echo ($m["mname"]); ?></a><?php endforeach; endif; ?>
        </nav>
      ...
      <div class="col-8" id="main">
        <div class="res-cons">
          <?php if(is_array($list)): foreach($list as $key=>$list): ?><article class="post">
              ...
              <div class="post-content"> <?php echo (subtext(htmlspecialchars_decode($list["content"]),300)); ?> </div>
